...
public class PCClientbackground {
	...
	private DataInputStream in; // 클라이언트가 보낸 메세지를 받을때 사용함
	private DataOutputStream out; // 메세지를 줄때 사용함
	private PcClientGui gui;
	...
	public void setGui(PcClientGui gui) {
		this.gui = gui;
	}
	public void setGui(UserLoginClient userLoginClient) {
